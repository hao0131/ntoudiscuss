...
<body background="blue-snow.png">
    ...
    <div id="d2">
        ...
        <button type="button" id="edit_button">編輯文章</button>
        <button type="button" id='okbutt' class="butt2">完成</button>
        ...
        <textarea id="post_context" maxlength="450" ></textarea>
    ...
    <div class="post">
		...
		<form action="delete_comment.php" method="GET">
			<button type="submit" class="butt3" id="delete_button">
               刪除留言
            </button>
		
		<?php echo '<input type="hidden" id='.$comment['comment_ID'].' name=comment_ID'.' value='.$comment['comment_ID'].'></input>'; ?>
